    ...
    <ul class="nav">
        ...
        <div class="profile-desc">
            ...
            <div class="profile-name">
                <h5 class="mb-0 font-weight-normal">SENDA CEDRIC</h5>
                <span>MANAGER</span>
            </div>
            </div>
        ...
        <a class="nav-link" href=" {{ route('stagiaire') }} ">
            ...
            <span class="menu-title">Stagiares</span>
        </a>
        </li>
        <li class="nav-item menu-items">
        <a class="nav-link" href=" {{ route('coordonnee') }} ">
            <span class="menu-icon">
        ...
        <a class="nav-link" href=" {{ route('inscription') }} ">
            ...
            <span class="menu-title">Inscription Solicitées</span>
        </a>
        </li>
        <li class="nav-item menu-items">
